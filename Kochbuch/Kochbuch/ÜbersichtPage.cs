...
namespace Kochbuch
{
	public class ÜbersichtPage : ContentPage
	{
        ...
        private ÜbersichtPage()
        {
            ...
            Label willkommenstext = new Label();
            willkommenstext.HorizontalOptions = LayoutOptions.Start;
            willkommenstext.VerticalOptions = LayoutOptions.CenterAndExpand;
            willkommenstext.FontSize= Device.GetNamedSize(NamedSize.Large, typeof(Label));
            willkommenstext.Text = "Etwas Neues für ihre Küche!";

            layout.Children.Add(willkommenstext);
            /*
